...
<div id="grid1">
	...
	<div class="container-fluid mt-5 pt-2">
		<div class="row">
			<div class="col-md-8">
				<img src="img/13.jpg" class="img-fluid ml-4" data-aos="fade-right" alt="..." style="max-width: 100%;">
			</div>
			<div class="col-md-4 my-auto" align="center">
				<h1 class="text-white mb-3"  data-aos="fade-down"> Decoration Info:</h1>
				<hr class="dotted" data-aos="fade-left">
				<p class="text-white"  data-aos="fade-up"> Dimensions: 42x28x16</p>
				<p class="text-white"  data-aos="fade-up"> Rs 2499</p>
				<a class="nav-link" href="addtocart1.php" button type="button" class="btn btn-outline-warning mr-2" data-aos="fade-up">Add to Cart</button></a>
	...
	<h1 class="text-warning mt-5 pt-5" align="center"> Popular Decorations</h1>
	<hr class='dotted'/ >
	</div>
