	...
	<div class="container-fluid mt-4">
		<div class="row">
			<div class="card ml-4 bg-dark" style="width: 30rem;" data-aos="fade-left">
                ...
                <a class="link-overlay" href="dec1.php"></a>
                	<div class="card-text">
	                    <a href="login.html"><button type="button" class="btn btn-outline-danger mr-2"><i class="bi-suit-heart-fill"></i></button></a>
	                    <a href="register.html"><button type="button" class="btn btn-outline-light mr-2"><i class="bi-plus-lg"></i></button></a>
                	</div>
			  	 </div>
			</div>
			<div class="card mx-auto bg-dark" style="width: 30rem;" data-aos="fade-left">
			  	...
			  	<div class="image-overlay image-overlay--blur">
				<a class="link-overlay" href="dec2.php"></a>
                	<div class="card-text">
	                    <a href="login.html"><button type="button" class="btn btn-outline-danger mr-2"><i class="bi-suit-heart-fill"></i></button></a>
	                    <a href="register.html"><button type="button" class="btn btn-outline-light mr-2"><i class="bi-plus-lg"></i></button></a>
				  	</div>
			...
			<div class="card mr-4 bg-dark" style="width: 30rem;" data-aos="fade-left">
			  	...
			  	<div class="image-overlay image-overlay--blur">
				<a class="link-overlay" href="dec3.php"></a>
                	<div class="card-text">
	                    <a href="login.html"><button type="button" class="btn btn-outline-danger mr-2"><i class="bi-suit-heart-fill"></i></button></a>
	                    <a href="register.html"><button type="button" class="btn btn-outline-light mr-2"><i class="bi-plus-lg"></i></button></a>
				  	</div>
		...
		<div class="row mt-4">
			<div class="card ml-4 bg-dark" style="width: 30rem;" data-aos="fade-right">
			  	...
			  	<div class="image-overlay image-overlay--blur">
				<a class="link-overlay" href="dec4.php"></a>
                	<div class="card-text">
	                    <a href="login.html"><button type="button" class="btn btn-outline-danger mr-2"><i class="bi-suit-heart-fill"></i></button></a>
	                    <a href="register.html"><button type="button" class="btn btn-outline-light mr-2"><i class="bi-plus-lg"></i></button></a>
				  	</div>
			...
			<div class="card mx-auto bg-dark" style="width: 30rem;" data-aos="fade-right">
			  	...
			  	<div class="image-overlay image-overlay--blur">
				<a class="link-overlay" href="dec5.php"></a>
                	<div class="card-text">
	                    <a href="login.html"><button type="button" class="btn btn-outline-danger mr-2"><i class="bi-suit-heart-fill"></i></button></a>
	                    <a href="register.html"><button type="button" class="btn btn-outline-light mr-2"><i class="bi-plus-lg"></i></button></a>
				  	</div>
			...
			<div class="card mr-4 bg-dark" style="width: 30rem;" data-aos="fade-right">
			  	...
			  	<div class="image-overlay image-overlay--blur">
				<a class="link-overlay" href="dec6.php"></a>
                	<div class="card-text">
	                    <a href="login.html"><button type="button" class="btn btn-outline-danger mr-2"><i class="bi-suit-heart-fill"></i></button></a>
	                    <a href="register.html"><button type="button" class="btn btn-outline-light mr-2"><i class="bi-plus-lg"></i></button></a>
				  	</div>
		...
		<div class="row mt-4">
			<div class="card ml-4 bg-dark" style="width: 30rem;" data-aos="fade-left">
			  	...
			  	<div class="image-overlay image-overlay--blur">
				<a class="link-overlay" href="dec7.php"></a>
                	<div class="card-text">
	                    <a href="login.html"><button type="button" class="btn btn-outline-danger mr-2"><i class="bi-suit-heart-fill"></i></button></a>
	                    <a href="register.html"><button type="button" class="btn btn-outline-light mr-2"><i class="bi-plus-lg"></i></button></a>
				  	</div>
			...
			<div class="card mx-auto bg-dark" style="width: 30rem;" data-aos="fade-left">
			  	...
			  	<div class="image-overlay image-overlay--blur">
				<a class="link-overlay" href="dec8.php"></a>
                	<div class="card-text">
	                    <a href="login.html"><button type="button" class="btn btn-outline-danger mr-2"><i class="bi-suit-heart-fill"></i></button></a>
	                    <a href="register.html"><button type="button" class="btn btn-outline-light mr-2"><i class="bi-plus-lg"></i></button></a>
				  	</div>
			...
			<div class="card mr-4 bg-dark" style="width: 30rem;" data-aos="fade-left">
			  	...
			  	<div class="image-overlay image-overlay--blur">
				<a class="link-overlay" href="dec9.php"></a>
                	<div class="card-text">
	                    <a href="login.html"><button type="button" class="btn btn-outline-danger mr-2"><i class="bi-suit-heart-fill"></i></button></a>
	                    <a href="register.html"><button type="button" class="btn btn-outline-light mr-2"><i class="bi-plus-lg"></i></button></a>
				  	</div>
		...
		<div class="row mt-4">
			<div class="card ml-4 bg-dark" style="width: 30rem;" data-aos="fade-right">
			  	...
			  	<div class="image-overlay image-overlay--blur">
				<a class="link-overlay" href="dec10.php"></a>
                	<div class="card-text">
	                    <a href="login.html"><button type="button" class="btn btn-outline-danger mr-2"><i class="bi-suit-heart-fill"></i></button></a>
	                    <a href="register.html"><button type="button" class="btn btn-outline-light mr-2"><i class="bi-plus-lg"></i></button></a>
				  	</div>
			...
			<div class="card mx-auto bg-dark" style="width: 30rem;" data-aos="fade-right">
			  	...
			  	<div class="image-overlay image-overlay--blur">
				<a class="link-overlay" href="dec11.php"></a>
                	<div class="card-text">
	                    <a href="login.html"><button type="button" class="btn btn-outline-danger mr-2"><i class="bi-suit-heart-fill"></i></button></a>
	                    <a href="register.html"><button type="button" class="btn btn-outline-light mr-2"><i class="bi-plus-lg"></i></button></a>
				  	</div>
			...
			<div class="card mr-4 bg-dark" style="width: 30rem;" data-aos="fade-right">
			  	...
			  	<div class="image-overlay image-overlay--blur">
				<a class="link-overlay" href="dec12.php"></a>
                	<div class="card-text">
