...
<div id="grid1">
	...
	<div class="container-fluid mt-5 pt-2">
		<div class="row">
			<div class="col-md-8">
				<img src="img/1.png" class="img-fluid ml-4" data-aos="fade-right" alt="..." style="max-width: 100%;">
			</div>
			<div class="col-md-4 my-auto" align="center">
				...
				<a class="nav-link" href="addtocart.php" button type="button" class="btn btn-outline-warning mr-2" data-aos="fade-up">Add to Cart</button></a>
